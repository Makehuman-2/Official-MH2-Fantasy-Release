...
*This program is still in Alpha II state. Feel free to report any and all bugs on github or steam-Please be patient with our progress ;)*
...
There are many methods to get the code, either with the git tools or simply download the zip file and unpack it where you want your code.
...
Also you can download from steam 
Download here-
https://store.steampowered.com/app/4676360/Makehuman_2/

or from the Makehuman 2 download page on its webpage.
Download here-  
https://makehuman-2.github.io/resources/third/
```
git pull
```
...
Further information you will find on the MakeHuman 2 Website pages soon. 
Also find us on discord:
https://discord.gg/yVwxahNeVz
And youtube:
https://www.youtube.com/channel/UCq6DefC9omB9sbZ90msblDA
